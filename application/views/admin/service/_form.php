...
if (isset($service) && count($service) > 0) {
  $id = $service[0]->ue_service_id;
  $name = $service[0]->ue_service_name;
  $image = $service[0]->ue_service_icon;
  $description = $service[0]->ue_service_description;
  $status = $service[0]->ue_service_status;
}
...
$action = base_url() . "admin/service/add";
if ($ur2 == "detail") {
  $action = base_url() . "admin/service/detail/" . $ur3;
}
?>
<div class="row">
  <div class="col-md-12">
    <div class="box box-default form-body">
      ...
      <div class="box-body">
        ...
        <form method="post" autocomplete="off" action="<?php echo $action; ?>" enctype="multipart/form-data">
          ...
          <?php
          if (!empty($image) && file_exists("./uploads/service/" . $image)) :
          ?>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="image">Gambar Saat Ini</label><br />
                  <img src="<?php echo base_url(); ?>uploads/service/<?php echo $image; ?>" alt="" width="350" />
                </div>
              </div>
            </div>
          <?php
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="image">Ikon <span class="mandatory"><small>(Max. Size: 500KB)</small></span></label>
          ...
          <div class="box-tools">
            ...
            if (isset($this->session->userdata["currentpage"]) && !empty($this->session->userdata["currentpage"])) {
              ...
              $currentpage = base_url() . "admin/service";
            }
            ?>
