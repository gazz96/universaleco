...
$link_name = base_url() . "admin/service/index/" . $ur3 . "/name/desc/" . $ur6 . $search;
$link_status = base_url() . "admin/service/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
...
if (empty($ur4)) {
	...
	$link_name = base_url() . "admin/service/index/" . $ur3 . "/name/asc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "asc") {
	$arrow_status = "fa fa-angle-down";
	$link_status = base_url() . "admin/service/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "desc") {
	$arrow_status = "fa fa-angle-up";
	$link_status = base_url() . "admin/service/index/" . $ur3 . "/status/asc/" . $ur6 . $search;
}
?>
...
<div class="row mt40 mb20 header-section">
	...
	<div class="col-md-6" style="text-align: right;">
		<form name="search-form" method="post" action="<?php echo base_url(); ?>admin/service/search/<?php echo $searchlink; ?>">
		...
		<div class="table-responsive">
			<table class="table table-grey">
				...
				?>
						<tr>
							<td><?php echo $x; ?></td>
							<td><?php echo $services->ue_service_name; ?></td>
							<td><img src="<?php echo base_url() . "uploads/service/" . $services->ue_service_icon; ?>" alt="" width="150" /></td>
							<td><?php echo $services->ue_service_status == 1 ? 'Aktif' : 'Tidak Aktif'; ?></td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/service/detail/<?php echo $services->ue_service_id; ?>" class="action-link"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/service/moveup/<?php echo $services->ue_service_id; ?>" class="action-link"><i class="fa fa-arrow-up" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/service/movedown/<?php echo $services->ue_service_id; ?>" class="action-link"><i class="fa fa-arrow-down" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/service/delete/<?php echo $services->ue_service_id; ?>" onclick="dialconfirm('<?php echo $services->ue_service_id; ?>');return false;" id="del-button<?php echo $services->ue_service_id; ?>" class="action-link"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</td>
						</tr>
					<?php
						$x++;
					...
					?>
					<tr>
						<td colspan="8" align="center">Layanan tidak dapat ditemukan</td>
					</tr>
				<?php
				endif;
				?>
