...
if (isset($homepage) && count($homepage) > 0) {
  $id = $homepage[0]->ue_homepage_id;
  $title = $homepage[0]->ue_homepage_title;
  $link = $homepage[0]->ue_homepage_link;
  $image = $homepage[0]->ue_homepage_url;
  $description = $homepage[0]->ue_homepage_description;
  $status = $homepage[0]->ue_homepage_status;
}
...
$action = base_url() . "admin/homepage/add";
if ($ur2 == "detail") {
  $action = base_url() . "admin/homepage/detail/" . $ur3;
}
?>
<div class="row">
  <div class="col-md-12">
    <div class="box box-default form-body">
      ...
      <div class="box-body">
        ...
        <form method="post" autocomplete="off" action="<?php echo $action; ?>" enctype="multipart/form-data">
          ...
          <?php
          if (!empty($image) && file_exists("./uploads/homepage/" . $image)) :
          ?>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="image">Gambar Saat Ini</label><br />
                  <img src="<?php echo base_url(); ?>uploads/homepage/<?php echo $image; ?>" alt="" width="350" />
                </div>
              </div>
            </div>
          <?php
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="link">Link <span class="mandatory"><small>(eg. http://google.com)</small></span></label>
          ...
          <div class="box-tools">
            ...
            if (isset($this->session->userdata["currentpage"]) && !empty($this->session->userdata["currentpage"])) {
              ...
              $currentpage = base_url() . "admin/homepage";
            }
            ?>
