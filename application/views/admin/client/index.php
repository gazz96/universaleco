...
$link_name = base_url() . "admin/client/index/" . $ur3 . "/name/desc/" . $ur6 . $search;
$link_status = base_url() . "admin/client/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
...
if (empty($ur4)) {
	...
	$link_name = base_url() . "admin/client/index/" . $ur3 . "/name/asc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "asc") {
	$arrow_status = "fa fa-angle-down";
	$link_status = base_url() . "admin/client/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "desc") {
	$arrow_status = "fa fa-angle-up";
	$link_status = base_url() . "admin/client/index/" . $ur3 . "/status/asc/" . $ur6 . $search;
}
?>

<div class="row mt40 mb20 header-section">
	<div class="col-md-6">
		<a href="<?php echo base_url(); ?>admin/client/add">
			<button class="btn btn-primary blue-bg">Tambah Data Baru</button>
		</a>
	</div>
	<div class="col-md-6" style="text-align: right;">
		<form name="search-form" method="post" action="<?php echo base_url(); ?>admin/client/search/<?php echo $searchlink; ?>">
		...
		<div class="table-responsive">
			<table class="table table-grey">
				...
				?>
						<tr>
							<td><?php echo $x; ?></td>
							<td><?php echo $clients->ue_client_name; ?></td>
							<td><img src="<?php echo base_url() . "uploads/client/" . $clients->ue_client_icon; ?>" alt="" width="150" /></td>
							<td><?php echo $clients->ue_client_status == 1 ? 'Aktif' : 'Tidak Aktif'; ?></td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/client/detail/<?php echo $clients->ue_client_id; ?>" class="action-link"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/client/moveup/<?php echo $clients->ue_client_id; ?>" class="action-link"><i class="fa fa-arrow-up" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/client/movedown/<?php echo $clients->ue_client_id; ?>" class="action-link"><i class="fa fa-arrow-down" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/client/delete/<?php echo $clients->ue_client_id; ?>" onclick="dialconfirm('<?php echo $clients->ue_client_id; ?>');return false;" id="del-button<?php echo $clients->ue_client_id; ?>" class="action-link"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</td>
						</tr>
					<?php
						$x++;
					...
					?>
					<tr>
						<td colspan="8" align="center">Klien tidak dapat ditemukan</td>
					</tr>
				<?php
				endif;
				?>
