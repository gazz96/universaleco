...
$link_name = base_url() . "admin/limbah-category/index/" . $ur3 . "/name/desc/" . $ur6 . $search;
$link_status = base_url() . "admin/limbah-category/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
...
if (empty($ur4)) {
	...
	$link_name = base_url() . "admin/limbah-category/index/" . $ur3 . "/name/asc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "asc") {
	$arrow_status = "fa fa-angle-down";
	$link_status = base_url() . "admin/limbah-category/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "desc") {
	$arrow_status = "fa fa-angle-up";
	$link_status = base_url() . "admin/limbah-category/index/" . $ur3 . "/status/asc/" . $ur6 . $search;
}
?>

<div class="row mt40 mb20 header-section">
	<div class="col-md-6">
		<a href="<?php echo base_url(); ?>admin/limbah-category/add">
			<button class="btn btn-primary blue-bg">Tambah Data Baru</button>
		</a>
	</div>
	<div class="col-md-6" style="text-align: right;">
		<form name="search-form" method="post" action="<?php echo base_url(); ?>admin/limbah-category/search/<?php echo $searchlink; ?>">
	...
	<div class="col-md-12 white-section">
		<div class="table-responsive">
			<table class="table table-grey">
				<tr>
					<th>&nbsp;</th>
					<th><a href="<?php echo $link_name; ?>">Kategori Kode Limbah <i class="<?php echo $arrow_name; ?>"></i></a></th>
					<th><a href="<?php echo $link_status; ?>">Status <i class="<?php echo $arrow_status; ?>"></i></a></th>
					<th colspan="2" width="7%" class="text-center">Aksi</th>
				</tr>
				<?php
				if (isset($limbahcategory) && count($limbahcategory) > 0) :
					$x = (($ur3 - 1) * 15) + 1;
					foreach ($limbahcategory as $limbahcategorys) :
				?>
						<tr>
							<td><?php echo $x; ?></td>
							<td><?php echo $limbahcategorys->ue_limbah_category_name; ?></td>
							<td><?php echo $limbahcategorys->ue_limbah_category_status == 1 ? 'Aktif' : 'Tidak Aktif'; ?></td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/limbah-category/detail/<?php echo $limbahcategorys->ue_limbah_category_id; ?>" class="action-link"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/limbah-category/delete/<?php echo $limbahcategorys->ue_limbah_category_id; ?>" onclick="dialconfirm('<?php echo $limbahcategorys->ue_limbah_category_id; ?>');return false;" id="del-button<?php echo $limbahcategorys->ue_limbah_category_id; ?>" class="action-link"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</td>
						</tr>
					<?php
						$x++;
					...
					?>
					<tr>
						<td colspan="5" align="center">Kategori kode limbah tidak dapat ditemukan</td>
					</tr>
				<?php
				endif;
				?>
