...
$link_title = base_url() . "admin/blog/index/" . $ur3 . "/title/desc/" . $ur6 . $search;
$link_status = base_url() . "admin/blog/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
...
if (empty($ur4)) {
	...
	$link_title = base_url() . "admin/blog/index/" . $ur3 . "/title/asc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "asc") {
	$arrow_status = "fa fa-angle-down";
	$link_status = base_url() . "admin/blog/index/" . $ur3 . "/status/desc/" . $ur6 . $search;
} else if ($ur4 == "status" && $ur5 == "desc") {
	$arrow_status = "fa fa-angle-up";
	$link_status = base_url() . "admin/blog/index/" . $ur3 . "/status/asc/" . $ur6 . $search;
}
?>
...
<div class="row mt40 mb20 header-section">
	...
	<div class="col-md-6" style="text-align: right;">
		<form name="search-form" method="post" action="<?php echo base_url(); ?>admin/blog/search/<?php echo $searchlink; ?>">
		...
		<div class="table-responsive">
			<table class="table table-grey">
				...
				?>
						<tr>
							<td><?php echo $x; ?></td>
							<td><?php echo $blogs->ue_blog_title ?></td>
							<td>
								<?php
								if ($blogs->ue_blog_image != null && file_exists("./uploads/blog/" . $blogs->ue_blog_image)) :
								?>
									<img src="<?php echo base_url(); ?>uploads/blog/<?php echo $blogs->ue_blog_image; ?>" alt="" width="100">
								<?php
								endif;
								?>
							</td>
							<td><?php echo $blogs->ue_blog_status == 1 ? 'Aktif' : 'Tidak Aktif'; ?></td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/blog/detail/<?php echo $blogs->ue_blog_id; ?>" class="action-link"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							</td>
							<td align="center">
								<a href="<?php echo base_url(); ?>admin/blog/delete/<?php echo $blogs->ue_blog_id; ?>" onclick="dialconfirm('<?php echo $blogs->ue_blog_id; ?>');return false;" id="del-button<?php echo $blogs->ue_blog_id; ?>" class="action-link"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</td>
						</tr>
					<?php
						$x++;
					...
					?>
					<tr>
						<td colspan="6" align="center">Blog tidak dapat ditemukan</td>
					</tr>
				<?php
				endif;
				?>
