...
if (isset($category) && count($category) > 0) {
  $id = $category[0]->ue_waste_category_id;
  $name = $category[0]->ue_waste_category_name;
  $image = $category[0]->ue_waste_category_icon;
  $status = $category[0]->ue_waste_category_status;
}
...
if ($ur2 == "detail") {
  $action = base_url() . "admin/category/detail/" . $ur3;
}
?>
<div class="row">
  <div class="col-md-12">
        ...
        <form method="post" autocomplete="off" action="<?php echo $action; ?>" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <img src="<?php echo base_url(); ?>uploads/category/<?php echo $image; ?>" alt="" width="350" />
                </div>
              </div>
            </div>
          <?php
          ...
          <div class="box-tools">
            ...
            if (isset($this->session->userdata["currentpage"]) && !empty($this->session->userdata["currentpage"])) {
              ...
              $currentpage = base_url() . "admin/category";
            }
            ?>
